...
|![Sélection du mois](https://imgur.com/BcenKeq.png)|![Statistiques Back Office](https://imgur.com/2dqzutJ.png)|
|:---:|:---:|
...
- **Tous les droits** : Active tous les droits sur le vendeur sélectionné.
...
<p align="center">
  <img src="https://media.giphy.com/media/fVbVz5kUNRMON6Vd5W/giphy.gif">
</p>
...
|![Imgur](https://i.imgur.com/JIwWf9n.png)|![Imgur](https://i.imgur.com/RYIxo7C.png)|![Imgur](https://i.imgur.com/3AqihEy.png)|
|:---------------------------------------:|:---------------------------------------:|:---------------------------------------:|
...
![Duplication article](https://i.imgur.com/PRNWHhB.png)
...
![Supp article](https://i.imgur.com/cHVwP4O.png)
...
- **Ouverture par défaut** : Ce qui ouvrira ce menu par défaut à la sélection de la catégorie menu.
- **Invisible** : Le menu n'apparait plus en ventes. Très pratique pour des menus type noël afin de ne pas devoir les recréer tous les ans.
...
- **Etape** : C'est ici que vous sélectionnez le niveau de suite de cette étape.
- **Prix à déduire** : Dans le cas où une étape d'un menu n'est pas prise par le client la caisse déduira automatiquement le **"prix  déduire"** pour cette étape là.

Vous retrouverez également deux touches supplémentaires en bas de ce pop-up :

- **Réordonner** : Cette fonction va réordonner tous les articles contenu dans une étape par ordre alphabétique au lieu de l'ordre dans lequel ils ont été placé.
- **Supprimer** : Sert  supprimer l'étape sélectionnée.
...
|![Création étapes menu](https://imgur.com/3uSFlfv.png)|![Déplacement d'article](https://imgur.com/9VwCG5b.png)|
|:----------------------------------------------------:|:-----------------------------------------------------:|
|![menu programmé](https://imgur.com/HrdOVLj.png)      |![Menu terminé](https://imgur.com/cUtCOGR.png)         |
...
<span style="color:#F78181">**ATTENTION : Vous ne pouvez pas sélectionner un nombre de sélections inférieur à votre nombre de sélections créées (Ex : si vous avez actuellement 7 sélections de créées, vous ne pouvez pas changer le nombre de lignes à 6 ou inférieur).**</span>
...
- **Fermer la commande à la fin du paiement** : La commande se ferme et retourne sur la salle une fois le règlement terminé.
- **Afficher les raccourcis de paiement** : En vente affiche les raccourcis paiement pour les trois premiers moyens de règlements de la caisse.
- **Ouvrir automatiquement une nouvelle commande à la fin du paiement** : Une nouvelle commande est entamée automatiquement sans retourner sur la salle.
- **Ouvrir l'écran de paiement à l'impression de la note** : Une fois la note imprimée on passe sur l'écran de paiement, de même pour la réouverture d'une table après l'impression de la note.
- **Imprimer envoi en cuisine à la fin du paiement** : Une fois une commande clôturée l'envoi en préparation est effectué.
- **Activation des bippeurs** : Active l'utilisation de bippeurs clients.
- **Déconnecter l'utilisateur après la transmission en cuisine** : Une fois une commande envoyée le vendeur est déconnecté.
- **Déconnecter l'utilisateur après le paiement** : Déconnecte le vendeur seulement après un règlement de commande.
- **Salle sélectionnée par défaut** : A l'ouverture de la caisse, connexion d'un vendeur ou retour sur la salle, cette salle s'ouvrira par défaut.
- **Afficher le nom du propriétaire de la table sur la table** : Affiche sur le nom du vendeur propriétaire de la table sur la table dans le plan de salle.
- **Nombre d'impressions de note supplémentaires : 0** : Affiche sur la table le nombre d'impressions de la note qu'il y a eu.
...
|:---:|:---:|
|![plan de salle table](https://imgur.com/cZhxAUs.png)|![plan de salle liste](https://imgur.com/vl2n4Ou.png)|
...
- **Nouvelle table**
Afin de placer une nouvelle table restez appuyé sur un emplacement vide de la salle. Vous aurez alors une nouvelle table qui apparaît avec le prochain numéro de table disponible.

- **Déplacement d'une table**
Pour pouvoir déplacer une table déjà en place, restez appuyé sur la table jusqu'à avoir deux bandes grises horizontale et verticale qui apparaissent. Tout en restant appuyé déplacez votre table à l'emplacement souhaité puis relâchez.

- **Modification d'un table**
Sélectionner votre table que vous souhaitez modifier en appuyant une fois dessus. A ce moment un pop-up apparait, dans ce pop-up vous pouvez modifier le numéro d'une table ou sa forme (Rond ou Carré). C'est également dans ce même pop-up que vous pouvez supprimer une table.
...
![Ecran Fiscal](https://imgur.com/9HaoUVz.png)
...
![Fenêtre Chrome avec archives fiscales](https://imgur.com/RqCSE7X.png)
...
**ArchiveFiscale\_20180928121407\_J0001\_123456789\_FD5F9420-9BEA-4CCF-99D6-FE59031D59AC.zip**
...
<span style="color:#F78181">**Si une exportation est effectuée en cours de journée les données de la période en cours sont également exportées.**</span>
...
- Rendez-vous dans votre application **App Store**
- Cherche l'application appelé **ScannerSettings**

Une fois l'application **ScannerSettings** télécharger nous pouvons procéder au paramétrage.

- Démarrer l'application **ScannerSettings** et sélectionnez l'option **1D Scanner**.
- Allumez votre lecteur puis scannez les codes barres affichés à l'écran, ceci va effectuer une remise à 0 du lecteur.
- Maintenant une connexion bluetooth à l'iPad est possible. Restez appuyé sur les 2 boutons situé sur le dos du lecteur, jusqu'à entendre plusieurs bips.
- Rendez vous dans l'application **Réglages** de votre iPad et sélectionnez l'onglet **Bluetooth**
- Retrouvez la ligne **Socket CHS [XXXXXX]** et sélectionnez le. 
- Une fois connecté la ligne **Socket CHS [XXXXXX]** se retrouvera dans la section **"Connexion à mes appareils"** avec oui écris en fin de ligne.
